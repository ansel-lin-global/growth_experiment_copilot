...
import ExperimentOutput from '@/components/ExperimentOutput'
...
export default function ExperimentDesignPage() {
  ...
  const [lastRequest, setLastRequest] = useState<ExperimentDesignRequest | null>(null)
  ...
  return (
    <div className="min-h-screen bg-[#0B0F19] bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-purple-900/40 via-[#0B0F19] to-[#0B0F19]">
      ...
      <div className="max-w-[1600px] mx-auto p-6 grid lg:grid-cols-12 gap-6 h-[calc(100vh-100px)]">
        ...
        <div className="lg:col-span-7 h-full">
          {!result ? (
            <div className="h-full border-2 border-dashed border-purple-500/10 rounded-xl flex flex-col items-center justify-center text-slate-600 bg-purple-900/5">
            ...
            <ExperimentOutput result={result} inputs={lastRequest!} />
          )}
        </div>
      </div>
    </div>
